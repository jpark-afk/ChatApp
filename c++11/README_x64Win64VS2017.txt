...
data type ChatMessage from ChatApp.idl.
This example builds two applications, named ChatApp_publisher and
ChatApp_subscriber.
...
1. Launch Visual Studio in one of two ways:
        - By typing ChatApp-x64Win64VS2017.sln in the
          Command Prompt window.
        - By opening Visual Studio on your machine and then opening the
          ChatApp-x64Win64VS2017.sln file (in the
...
2. Select Build Solution from the Build menu. (You can also right-click
   ChatApp_publisher or ChatApp_subscriber and
...
To modify the data being sent: edit the ChatApp_publisher.cxx
file where it says 
...
1. Right-click ChatApp_publisher and choose Debug > Start new instance.
2. Right-click ChatApp_subscriber and choose Debug > Start new instance.
...
2. Run C:\RTI\rti_connext_dds-7.3.1\bin\..\resource\scripts\rtisetenv_x64Win64VS2017.bat
...
> objs\x64Win64VS2017\ChatApp_publisher.exe -d <domain_id> -s <sample_count>
> objs\x64Win64VS2017\ChatApp_subscriber.exe -d <domain_id> -s <sample_count>
